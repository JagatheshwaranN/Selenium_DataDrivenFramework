...
public class ReportListenerGrid extends ReusableComponentGrid implements ITestListener, ISuiteListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		String passTestCaseBase64Snapshot = "data:image/png;base64,"
				+ ((TakesScreenshot) Objects.requireNonNull(TestBaseGrid.driver)).getScreenshotAs(OutputType.BASE64);
