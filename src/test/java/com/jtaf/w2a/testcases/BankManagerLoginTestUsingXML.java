...
public class BankManagerLoginTestUsingXML extends ReusableComponent {
	...
	public void bankManagerLoginTest() throws InterruptedException {
		...
		elementClickUsingXML(xmlReaderUtil.getLocatorFromXML("Locators.HomePage.BankManagerLogin.CSS"));
		log.debug("Logged in as Bank Manager");
		Thread.sleep(5000);
		Assert.assertTrue(isElementPresentUsingXML(xmlReaderUtil.getLocatorFromXML("AddCustomerButton.CSS")));
